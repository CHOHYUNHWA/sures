...
import com.sures.admin.service.ReservationService;
...
public class AdminReservationController {
    ...
    public String list(
        ...
        Page<ReservationResponse> reservations = reservationService.searchReservations(searchRequest);
    ...
    public String create(
        ...
        try {
            Long id = reservationService.createReservation(request, null); // adminId는 추후 연결
    ...
    public java.util.List<String> getReservedTimes(
        ...
        if (excludeId != null) {
            return reservationService.getReservedTimesExcluding(date, excludeId)
                    .stream()
